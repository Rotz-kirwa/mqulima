      ...
      <div className="container-px mx-auto flex h-16 max-w-7xl items-center justify-between">
        <Link to="/" className="flex items-center gap-3">
          ...
          <div className="flex flex-col justify-center leading-none">
            <div className="font-serif text-[22px] font-normal tracking-[0.08em] text-foreground uppercase">
              MQULIMA
            </div>
            <div className="text-[10px] font-medium tracking-normal text-[#2D6A2F] lowercase mt-0.5 italic">
        ...
        <nav className="hidden items-center gap-1 lg:flex">
          {nav.map((n) => (
            <Link
              ...
              activeProps={{
                className:
                  "rounded-full px-4 py-2 text-sm font-semibold bg-primary/10 text-primary ring-1 ring-primary/20",
              }}
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {cartCount > 0 && (
              <span className="absolute -right-1 -top-1 grid h-5 w-5 place-items-center rounded-full bg-gold text-[10px] font-bold text-gold-foreground animate-pulse">
                {cartCount}
              </span>
            )}
          </button>
