          ...
          <div className="rounded-3xl bg-gradient-to-br from-blue to-primary p-7 text-forest-foreground shadow-elegant lg:col-span-2">
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="mt-1 text-sm text-forest-foreground/70">
                  Eldoret · Updated 12 min ago
                </div>
              </div>
            ...
            <div className="mt-6 flex items-center gap-2 rounded-xl bg-gold/15 p-3 text-xs text-gold ring-1 ring-gold/30">
              <Wind className="h-4 w-4" /> <span className="font-semibold">Seasonal alert:</span>{" "}
              Rains expected in Uasin Gishu by Wednesday — ideal time to plant maize.
            </div>
          </div>
            ...
            <ul className="mt-5 space-y-3 text-sm">
              {[
                ...
                >
                  ...
                  <span
                    className={`rounded-full ${r.color} px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-white`}
                  >
                    {r.action}
                  </span>
                </li>
